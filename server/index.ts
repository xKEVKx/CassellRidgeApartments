...
app.use((req, res, next) => {
  res.setHeader(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://acsbapp.com https://replit.com https://*.funnelleasing.com https://*.nestio.com",
      ...
      "img-src 'self' data: blob: https://www.google-analytics.com https://www.googletagmanager.com https://acsbapp.com https://*.matterport.com https://*.funnelleasing.com https://*.nestio.com https://nestiolistings.com https://*.nestiolistings.com",
      "frame-src 'self' https://www.portal.fortresstech.io https://discover.matterport.com https://www.google.com https://my.matterport.com https://*.funnelleasing.com https://*.nestio.com https://nestiolistings.com https://*.nestiolistings.com",
      "connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://acsbapp.com https://region1.google-analytics.com https://*.funnelleasing.com https://*.nestio.com https://nestiolistings.com https://*.nestiolistings.com",
      "media-src 'self'",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
